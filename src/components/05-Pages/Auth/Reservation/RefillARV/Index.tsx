...
import { useGetRefillArvQuery } from "@/redux/api/reservation.api";
...
const collapsibleFields: string[] = ["Jumlah refill", "MMD", "Tanggal refill selanjutnya", "Sudah PN", "Unique link"];

const collapsibleFieldsMap: { [key: string]: string } = {
  "Jumlah refill": "field_belum_ada",
  MMD: "field_belum_ada",
  "Tanggal refill selanjutnya": "field_belum_ada",
...
export default function Index() {
  ...
  return (
    <ReservationLayout title="Reservasi Refill ARV">
  <TableWithCollapse
        rows={rows}
        limit={limit}
